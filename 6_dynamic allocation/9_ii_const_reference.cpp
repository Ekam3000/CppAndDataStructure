...
int main() {
	...
	int const j3 = 123;
	int & k3 = j3;  // jab j3 ke pass hi sirf read access hai to k3 kese use overwrite karte kuch aur kar sakta hai . so k++ possible hi nii hai. error 21 line me hi aa jaye ga.
	k3++;
}
